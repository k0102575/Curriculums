...
public class TeacherListServlet extends HttpServlet {
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
    ...
    try {
      ...
      out.println("<a href='form.html'>새 강사</a><br>");
      ...
      for (Teacher t : list) {
        ...
        out.printf("<td><a href='detail?no=%d'>%s</a></td>" ,t.getNo(), t.getName(), t.getName());
        out.printf("<td>%s</td>", t.getTel());
        out.printf("<td>%s</td>", t.getEmail());
        out.printf("<td>%s</td>", t.getHomepage());
        out.println("</tr>");
