...
public class Test13 {
  public static void main(String[] args) {
    ...
    Student[] arr1 = new Student[3]; // 레퍼런스를 3개 만든다. 인스턴스를 3개 만드는 것이 아니다.
    
    // Student 인스턴스를 생성한 후 그 주소를 배열에 저장한다.
    arr1[0] = new Student();  // 인스턴스 배열을 만드는 문법이 자바에 없다.
    arr1[1] = new Student();  
    arr1[2] = new Student();
