...
public interface MemberDao {
  ...
  List<Member> selectListByName(int pageNo, int pageSize, String name) throws Exception; // selectListByName()

  List<Member> selectListByTel(int pageNo, int pageSize, String tel) throws Exception; // selectListByTel()
